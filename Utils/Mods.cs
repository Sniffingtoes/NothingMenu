...
namespace NothingMenu.Utils
{
    internal class ModsPP : MonoBehaviour
    {
        private const string OwnerListUrl = "https://raw.githubusercontent.com/Sniffingtoes/NothingMenu/refs/heads/main/stuff/mods.txt";
        private const string CrownResourceName = "NothingMenu.Resources.modicon.png";
        ...
        private GameObject GetOrCreateBadge(VRRig rig, int rigId)
        {
            ...
            badge = new GameObject("NothingModBadge");
